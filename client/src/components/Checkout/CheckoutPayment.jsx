...
export default function CheckoutPayment({ setStep, paymentMethod, setPaymentMethod }) {
    return (
        <div className="bg-white rounded-2xl p-6 animate-fade-in">
            ...
            <button onClick={() => { setStep("review"); scrollTo({ top: 0, behavior: "auto" }) }} className="mt-6 px-6 py-3 bg-app-green text-white font-semibold rounded-xl hover:bg-app-green-light transition-colors flex items-center gap-2">
